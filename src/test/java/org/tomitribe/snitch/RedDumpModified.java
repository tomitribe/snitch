...
public class RedDumpModified implements Opcodes {

    public static void main(String[] args) throws Exception {
        final byte[] dump = dump();
        Asmifier.asmify("org.tomitribe.snitch.Red", dump, "modified");
    ...
    public static byte[] dump() throws Exception {
        ...
        }
        {
            ...
            Enhance.enhance(cw, theTag, "org/tomitribe/snitch/Red", access, name, desc, signature, exceptions);
